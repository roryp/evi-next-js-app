  ...
  try {
    ...
    try {
      ...
      for (let i = 0; i < CANVAS_WIDTH; i++) {
        ...
        ctx.fillStyle = `rgba(255, ${Math.floor(255 * (1 - rms))}, 0, 0.8)`; // Increased opacity from 0.6 to 0.8
        const barWidth = 3; // Wider bars
      ...
      if (prosodyData.syllableBoundaries.length > 0) {
        ...
        wordFlowGradient.addColorStop(0, 'rgba(255, 100, 100, 0.8)'); // Red at top (increased opacity)
        wordFlowGradient.addColorStop(1, 'rgba(255, 200, 50, 0.4)'); // Orange-yellow at bottom (increased opacity)
        ctx.fillStyle = wordFlowGradient;
        ctx.fill();
      }
      
      // Draw syllable boundaries with improved visualization
      ctx.strokeStyle = 'rgba(255, 255, 0, 0.9)'; // Brightened yellow for syllables (increased opacity)
      ...
      // Fix: Use more robust PNG encoding with maximum compatibility
      try {
        // Force PNG format with no compression for maximum compatibility
        ...
        console.error('Error encoding canvas to PNG:', encodingError);
        throw new Error('Error generating spectrogram image: encoding failed');
      }
    } catch (canvasError) {
      ...
      try {
        ...
        return {
          image: 'data:image/png;base64,',
          prosody: null
        };
      }
    }
